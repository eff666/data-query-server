...
/**
 */
public class TimeLittleThan implements DimFilter {
	final private String dimension;
	final private String value;

	@JsonCreator
	public TimeLittleThan(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
	...
	public boolean equals(Object obj) {
		...
		TimeLittleThan rhs = (TimeLittleThan) obj;
