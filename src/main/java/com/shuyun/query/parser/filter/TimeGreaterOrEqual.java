...
/**
 */
public class TimeGreaterOrEqual implements DimFilter {
	final private String dimension;
	final private String value;

	@JsonCreator
	public TimeGreaterOrEqual(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
	...
	public boolean equals(Object obj) {
		...
		TimeGreaterOrEqual rhs = (TimeGreaterOrEqual) obj;
