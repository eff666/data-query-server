...
/**
 */
public class TimeLittleOrEqual implements DimFilter {
	final private String dimension;
	final private String value;

	@JsonCreator
	public TimeLittleOrEqual(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
	...
	public boolean equals(Object obj) {
		...
		TimeLittleOrEqual rhs = (TimeLittleOrEqual) obj;
