...
/**
 */
public class LittleThan implements DimFilter {
	final private String dimension;
	final private Number value;

	@JsonCreator
	public LittleThan(@JsonProperty("dimension") String dimension, @JsonProperty("value") Number value) {
