...
public class StrNotSelector implements DimFilter {
    final private String dimension;
    private String value;

    @JsonCreator
    public StrNotSelector(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
    ...
    public boolean equals(Object obj) {
        ...
        StrNotSelector rhs = (StrNotSelector) obj;
