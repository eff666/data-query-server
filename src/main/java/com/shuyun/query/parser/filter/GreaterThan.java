...
/**
 */
public class GreaterThan implements DimFilter {
	final private String dimension;
	final private Number value;

	@JsonCreator
	public GreaterThan(@JsonProperty("dimension") String dimension, @JsonProperty("value") Number value) {
	...
	public boolean equals(Object obj) {
		...
		GreaterThan rhs = (GreaterThan) obj;
