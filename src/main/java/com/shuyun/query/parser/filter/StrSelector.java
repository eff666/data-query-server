...
/**
 */
public class StrSelector implements DimFilter {
	final private String dimension;
    private String value;

	@JsonCreator
	public StrSelector(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
	...
	public boolean equals(Object obj) {
		...
		StrSelector rhs = (StrSelector) obj;
