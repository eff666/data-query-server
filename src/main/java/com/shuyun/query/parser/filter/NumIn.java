...
/**
 */
public class NumIn implements DimFilter {
	...
	@JsonCreator
	public NumIn(@JsonProperty("dimension") String dimension, @JsonProperty("value") List<Number> value) {
	...
	public String toString() {
		return String.format("%s in (%s)", dimension, COMMA_JOINER.join(value));
	}
}
