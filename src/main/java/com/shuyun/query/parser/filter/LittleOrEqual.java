...
/**
 */
public class LittleOrEqual implements DimFilter {
	final private String dimension;
	final private Number value;

	@JsonCreator
	public LittleOrEqual(@JsonProperty("dimension") String dimension, @JsonProperty("value") Number value) {
	...
	public boolean equals(Object obj) {
		...
		LittleOrEqual rhs = (LittleOrEqual) obj;
