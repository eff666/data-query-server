...
public class StrSearch implements DimSearch {
    final private String dimension;
    private String value;

    @JsonCreator
    public StrSearch(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
