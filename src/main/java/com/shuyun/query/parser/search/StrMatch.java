...
/**
 * Created by wanghaiwei on 2015/9/1.
 */


public class StrMatch implements DimSearch {
    final private String dimension;
    private String value;

    @JsonCreator
    public StrMatch(@JsonProperty("dimension") String dimension, @JsonProperty("value") String value) {
